    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AnnotationTitle', models.CharField(blank=True, max_length=70, null=True)),
                ('AnnotationType', models.CharField(blank=True, max_length=70, null=True)),
                ('AnnotationURL', models.URLField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('AnnotationText', models.TextField(blank=True, null=True)),
                ('language_code', models.CharField(db_index=True, max_length=15)),
                ('master', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='tranaslations', to='common.Annotation')),
            ],
            options={
                'db_table': 'common_annotation_translation',
                'db_tablespace': '',
                'abstract': False,
                'managed': True,
                'default_permissions': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('idc', models.CharField(blank=True, max_length=18, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ConceptAgency', models.CharField(blank=True, max_length=18, null=True)),
                ('ConceptSchemeID', models.CharField(blank=True, max_length=18, null=True)),
                ('ConceptID', models.CharField(blank=True, max_length=18, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Key',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language_code', models.CharField(db_index=True, max_length=15)),
                ('master', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='tranaslations', to='common.Text')),
            ],
            options={
                'db_table': 'common_text_translation',
                'db_tablespace': '',
                'abstract': False,
                'managed': True,
                'default_permissions': (),
