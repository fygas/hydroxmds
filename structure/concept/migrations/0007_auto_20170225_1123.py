...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('concept', '0006_auto_20170225_1116'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='concept',
            name='annotations',
            field=models.ManyToManyField(related_name='_concept_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='conceptscheme',
            name='annotations',
            field=models.ManyToManyField(related_name='_conceptscheme_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='conceptschemetranslation',
            name='name',
