...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('provision', '0006_auto_20170225_1116'),
    ]

    operations = [
        migrations.RenameField(
            model_name='provisiontranslation',
        ...
        migrations.AddField(
            model_name='provision',
            name='annotations',
            field=models.ManyToManyField(related_name='_provision_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='provisiontranslation',
            name='name',
