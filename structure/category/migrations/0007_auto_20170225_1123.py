...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('category', '0006_auto_20170225_1116'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='category',
            name='annotations',
            field=models.ManyToManyField(related_name='_category_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='categoryscheme',
            name='annotations',
            field=models.ManyToManyField(related_name='_categoryscheme_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='categoryschemetranslation',
            name='name',
