...
class Process(MaintainableArtefact):
    ProcessSteps = models.ManyToManyField('ProcessStep', null=True, blank=True)
    translations = TranslatedFields()

class ProcessStep(NameableArtefact):
    Input = models.ManyToManyField('InputOutpout', null=True, blank=True)
    Outpout = models.ManyToManyField('InputOutpout', null=True, blank=True)
    ...
    ProcessSteps = models.ManyToManyField('self', null=True, blank=True)
    translations = TranslatedFields()
...
class Transition(IdentifiableArtefact):
    ...
    Conditions = models.ManyToManyField(Text, null=True, blank=True)
