...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('codelist', '0008_auto_20170225_1123'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='codelist',
            name='id_code',
            field=models.CharField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator(re.compile('[A-Za-z][A-Za-z0-9_\\-]*', 32), 'Enter a value of type NCNameIDType that has pattern "([A-Za-z][A-Za-z0-9_\\-]*)"', 'invalid_pattern')], verbose_name='id'),
        ),
        migrations.AlterField(
            model_name='codelist',
            name='version',
