...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('codelist', '0007_auto_20170225_1116'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='code',
            name='annotations',
            field=models.ManyToManyField(related_name='_code_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='codelist',
            name='annotations',
            field=models.ManyToManyField(related_name='_codelist_annotations_+', to='common.Annotation'),
        ),
        migrations.AddField(
            model_name='codelisttranslation',
            name='name',
